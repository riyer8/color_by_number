...
class ImageManipulation:
    ...
    def reshape_image(self, img: Image.Image, target_size: int = 800, img_dir: str = "images_generated") -> tuple[Image.Image, str]:
    ...
    def get_rgb_data(self, img: Image.Image) -> np.ndarray:
        return np.array(img)